...
--
-- Host: 127.0.0.1    Database: bookstall
-- ------------------------------------------------------
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `gst` (
  `gstclass_id` int(10) NOT NULL AUTO_INCREMENT,
  `gstclass` varchar(50) NOT NULL,
  `CGST` double NOT NULL,
  `SGST` double NOT NULL,
  PRIMARY KEY (`gstclass_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-25 23:54:15
